import 'package:ecommerce_starter_app/src/features/orders/application/user_orders_provider.dart';
...
class LeaveReviewAction extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (orders != null && orders.isNotEmpty) {
      ...
      final dateFormatted = kDateFormatter.format(orders.first.orderDate);
      return Column(
        children: [
          const Divider(),
          gapH8,
