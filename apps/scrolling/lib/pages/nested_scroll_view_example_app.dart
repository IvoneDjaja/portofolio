            ...
            return <Widget>[
              SliverOverlapAbsorber(
                ...
                sliver: SliverAppBar(
                    ...
                    // shadow would appear or not appear inappropriately, because
                    // the SliverAppBar is not actually aware of the precise
                    // position of the inner scroll views.
                  ...
                  child: Builder(
                    ...
                    builder: (context) {
                      return CustomScrollView(
                          ...
                          // inner scroll view. If the "controller" property is set,
                          // then this scroll view will not be associated with the
                          // NestedScrollView. The PageStorageKey should be unique
                          // to this ScrollView; it allows the list to remember its
                          // scroll position when the tab view is not on the screen.
